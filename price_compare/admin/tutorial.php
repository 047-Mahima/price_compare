      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            ...
            <table class="table">
                <tr>
                    <th>Sr.</th><th>Name</th><th>Image</th><th>Delete</th>
                </tr>
                <?php
                $i=1;
       ...
       ?>
              ...
              <div class="widget">
                <h5 class="widgetheading">Add New Tutorial<span></span></h5>

                <form action="save.php" method="post" enctype="multipart/form-data">
                    <table class="table">
                        <tr>
                            <td>Enter Tutorial Name<br/><input type="text" name="tutorial" class="form-control" required="required"/></td>
                        </tr>
                       <tr>
                         <td>Choose Tutorial Logo<br/><input type="file" name="pic" class="form-control" required="required"></td>
                       </tr>
                        <tr>
