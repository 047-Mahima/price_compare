   ...
   <div id="wrapper">
    ...
    <section id="content">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h4 style="display: inline;">Avaiable Subcourse</h4>&nbsp;&nbsp;&nbsp;<a  href="add.php"><button class="btn btn-info">Add New</button></a>
       <?php 
       ...
       ?>
            ...
            <table class="table">
                <tr>
                    <th>Sr.</th><th>Tutorial</th><th>link</th><th>Price</th><th>Duration</th><th>Mentor</th><th>Category</th><th>Update</th><th>Delete</th>
                </tr>
                <?php
                $i=1;
